...
<head>
    ...
    <title>Project Monitoring</title> </head> <body>
            <!-- ============================================================== -->
            <!-- main wrapper -->
            <!-- ============================================================== -->
                        ...
                        <div class="container-fluid dashboard-content ">
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <p><b>Project Monitoring</b> merupakan web platform dalam memonitoring projek.
                                         Web ini ditujukan untuk seleksi Tahap 3 Divisi Web Developer Digitaliz oleh Yayasan Hasnur Centre</p>
                                        <p><b>Paltform</b> ini menggunakan Bahasa Pemrograman Server Side (PHP) dan
                                            Client Side (HTML, CSS, BOOTSTRAP 4, JAVA SCRIPT), dan menggunakan program
                                            XAMPP, Visual Studio Code, dan Browser.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
