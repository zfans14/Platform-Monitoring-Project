                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu show" style="">
                                    <ul class="nav flex-column">
                                                <li class="nav-item">
                                                    <a class="nav-link" href="pages/tables/customer/table_customer.php">Project Monitoring</a>
                                                </li>
                                        </ul>
                                </div>
                            </li>
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Tambah Data Project Monitoring</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Tables</a></li>
                                            <li class="breadcrumb-item"><a href="table_customer.php" class="breadcrumb-link">Project Monitoring</a></li>
                                            <li class="breadcrumb-item active" aria-current="page"></li>Form Tambah Data Project Monitoring
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <h5 class="card-header">Tambah Data Project Monitoring</h5>
                            <div class="card-body">
                                <form action="process/add_customer.php" method="POST">

                                    <?php 
                                    $tampilkan_isi = "select count(id) as jumlah from project_monitoring;";
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="id" class="form-control" value="CUS-<?php echo $no+$jumlah ?>"
                                                readonly>
                                        </div>
                                    </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            Copyright © 2022 Khazanah Indonesia Bookstore All rights reserved.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        </div>
                    </div>
