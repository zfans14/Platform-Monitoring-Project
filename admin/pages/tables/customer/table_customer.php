        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Project Monitoring</h2>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Tables</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Project Monitoring</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <h5 class="card-header">Project Monitoring</h5>
                            <div class="card-body">
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $query = "SELECT * FROM project_monitoring where deleted=0";
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            Copyright © 2022 Muhamad Zulfan All rights reserved.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        </div>
                    </div>
